...
public class AdmobVNTIS_Banner_Advanced : MonoBehaviour {
	...
	void Start(){
		...
		jo = new AndroidJavaObject ("admob.admob",PublisherID,TestDeviceID,true,rule);
	}
	...
	public void hideAdview(){
		jo.Call ("hideBannerGONE");
	}

	public bool isBannerVisible(){
		return jo.Call<bool>("isBannerVisible");
	}
}
